...
public class MenuInitialiser {
    ...
    public void init() {
        if (menuItemRepository.count() == 0) {
            // Vegan.
            MenuItem chiliCheezeBurgerMenü = new MenuItem("Chili Cheeze Burger Menü", "Chili Cheeze + Farm Fries",
            ...
            MenuItem funghiPizza = new MenuItem("Funghi Pizza", "Frische Champignons ", 10.90, "funghiPizza.png");
            ...
            MenuItem butterChicken = new MenuItem("Butter Chicken",
                    "Gegrillte Hühnerstücke mit Butter und Tomatensauce", 14.90, "butterChicken.png");
            MenuItem chickenTikkaMasalaPikant = new MenuItem("Chicken Tikka Masala (Pikant)",
                    "Gegrillte Hühnerstücke, in würzigem Curry", 14.90, "chickenTikkaMasalaPikant.png");
            ...
            MenuItem vegetarischesBiryaniVegan = new MenuItem("Vegetarisches Biryani (Vegan)",
                    "Basmatireis mit gemischten Gemüsesorten", 13.90, "vegetarischesBiryaniVegan.png");

            // Italian.
            MenuItem pastaAlfredo = new MenuItem("Pasta Alfredo", "Obers, DOP (Grana Padano) Käse und Knoblauch.",
                    10.71, "pastaAlfredo.png");
            MenuItem pastaCarbonara = new MenuItem("Pasta Carbonara", "Obers, Rind Speck, Zwiebel und Eigelb.", 13.41,
                    "pastaCarbonara.png");
            MenuItem pinsaVegana = new MenuItem("Pinsa Vegana", "Thunfisch, Zwiebel, Oliven", 10.90, "pinsaVegana.png");

            // Chinese.
            MenuItem nudelnMitKnusprigemHuhn = new MenuItem("Nudeln mit knusprigem Huhn", "Nudeln mit knusprigem Huhn",
            ...
            MenuItem doubleCheeseburgerMenü = new MenuItem("Double Cheeseburger Menü",
                    "Double Cheesburger mit einem Drink und Fries", 14.32, "doubleCheeseburgerMenü.png");
            MenuItem doubleBaconJam = new MenuItem("Double Bacon Jam",
                    "Mit Senf Mayo, Essiggurken, Beef Bacon Jam und Zwiebel.", 11.90, "doubleBaconJam.png");
            MenuItem halloumiBurger = new MenuItem("Halloumi Burger",
                    "Mit Kräuterpesto, Essiggurken, Aioli und Salatmix.", 11.90, "halloumiBurger.png");

            // Thai.
            MenuItem phadThaiNationalgericht = new MenuItem("Phad Thai (Nationalgericht)",
                    "Gebratene Reisnudeln mit Ei, Thaibärlauch & Erdnuss", 12.80, "phadThaiNationalgericht.png");
            ...
            MenuItem geangKhiaoWan = new MenuItem("Geang Khiao Wan",
                    "Grünes Thai Curry mit Fisolen, Bambussprossen, Kokosmilch dazu Reis", 13.80, "geangKhiaoWan.png");
